...
let actionsFunction = {
  ...
  createExam: function (exam) {
    return function (dispatch) {
      return ExamApi.createExam(exam)
        .then((exam) => {
  ...
  findBy_course: function (key) {
    return function (dispatch) {
      return ExamApi.findBy_course(key)
        .then((item) => {
  ...
  findBy_student: function (key) {
    return function (dispatch) {
      return ExamApi.findBy_student(key)
        .then((item) => {
  ...
  findBy_teacher: function (key) {
    return function (dispatch) {
      return ExamApi.findBy_teacher(key)
        .then((item) => {
  ...
  */
  validate: function (...params) {
    return function (dispatch) {
      return ExamApi.validate(params)
        .then((result) => {
