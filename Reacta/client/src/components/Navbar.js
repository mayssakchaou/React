    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          <div className="navbar-drawer-text">Pfe Management</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
          ...
          <Link to="/PfeListadmin">
            <ListItem button key="course">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Pfe" />
            </ListItem>
          </Link>{" "}
          <Link to="/AnneeUniversitaire">
